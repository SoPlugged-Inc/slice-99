...
export const BrandLanding: React.FC = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      copy: "We don’t just send you a file. The creator posts the video to their own feed, putting your brand in front of thousands of potential shoppers.",
      renderVisual: () => (
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center w-full">
          ...
          <div className={`transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <p className="text-lg sm:text-xl text-neutral-dark mb-8 max-w-2xl mx-auto leading-relaxed">
              We pool non-competing brands to split the cost of a viral-style Influencer Haul. You get the content you need, and we handle the rest.
            </p>
